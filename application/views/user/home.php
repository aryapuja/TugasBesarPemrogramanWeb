          ...
          <div class="col-lg-6 order-lg-1 my-auto showcase-text">
            ...
            <p class="lead mb-0">
              <?php foreach ($waktu as $info ) { ?>
                Tanggal akhir pendaftaran calon pimpinan: <?php echo date('d-F-Y',strtotime($info->mulai."-2 week")); ?> <br>
                Tanggal pemilihan dimulai: <?php echo date('d-F-Y',strtotime($info->mulai)); ?> <br>
                Tanggal pemilihan berakhir: <?php echo date('d-F-Y',strtotime($info->selesai)); ?>
            <?php } ?>
            </p>
          </div>
        </div>
